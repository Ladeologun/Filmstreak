import { Fragment, forwardRef, LegacyRef, useEffect, useImperativeHandle, useRef, useState } from "react";
...
const Walkthrough = forwardRef<WalkthroughHandle, Props>(({
    ...
    useEffect(() => {
        childRef?.current && childRef?.current.measure(
                    ...
                    >
                        ...
                        <View style={styles.headerActionContainer}>
                            ...
                            <TouchableOpacity onPress={onNext}>
                                <Text style={[styles.headerActionBtnText, styles.headerActionBtnTextNext]}>{nextBtnText ?? "Next"}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
